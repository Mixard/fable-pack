---
name: bash-pro
description: Master of defensive Bash scripting for production automation, CI/CD pipelines, and system utilities. Expert in safe, portable, and testable shell scripts. Use PROACTIVELY when writing or reviewing shell scripts, CLI tooling, or pipeline automation.
model: sonnet
---
