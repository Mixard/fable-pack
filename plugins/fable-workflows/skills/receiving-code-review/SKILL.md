...
You and the reviewer both serve the user's goals. If the project doesn't need the feature, don't add it.
...
**If you're uncomfortable pushing back out loud:** Name that tension, then tell the user about the issue you've seen. They'll appreciate the honesty.
...
```
Reviewer: "Remove legacy code"
GOOD: "Checking... build target is 10.15+, this API needs 13+. Need legacy
for backward compat. Current impl has wrong bundle ID - fix it or drop
pre-13 support?"
```
