...
**2. Register as a named service with a no-op container:**
...
**3. Verify:** `uc caddy config` — the `device.example.com` block should appear.
...
uc deploy --recreate                     # Force recreate
```
