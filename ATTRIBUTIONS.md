...
|--------|---------|--------------|
| [affaan-m/ECC](https://github.com/affaan-m/ECC) (everything-claude-code) | MIT | fable-knowledge: 46 of 47 skills from ECC triage (29 from the 183-skill revision, 18 from the 278-skill revision, minus regex-llm-hybrid removed in 1.0.0); n8n-selfhosted-ops is original |
| [obra/superpowers](https://github.com/obra/superpowers) | MIT | fable-workflows: 11 of 15 skills (project-cartography, getting-unstuck, critical-review, solution-hunter are original; dispatching-parallel-agents removed in 1.0.0) |
| [wshobson/agents](https://github.com/wshobson/agents) | MIT | fable-agents: 21 of 22 agents (23 adapted; sql-pro and devops-troubleshooter merged into database-optimizer and incident-responder in 1.0.0; quant-critic is original, added in 1.2.0) |
