...
|------|---------|------------|
| 2026-09-16 | fable-workflows 2.1.1 | verification-before-completion now triggers at the start of multi-part work too, and executing-plans / subagent-driven-development point to "Define Done Before the Work" before the first task — the 2.1.0 section was only reachable after the work it governs |
